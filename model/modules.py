...
from model.commons import init_weights, get_padding, fused_add_tanh_sigmoid_multiply
...
class ConvReluNorm(nn.Module):
    def __init__(self,
        ...
        self.norm_layers.append(LayerNorm(channels=hidden_channels))
  ...
  """
    ...
    def __init__(self,
        ...
        for i in range(n_layers):
            ...
            self.convs_1x1.append(nn.Conv1d(
                in_channels=channels,
                out_channels=channels,
                kernel_size=1
            ))

            self.norms_1.append(LayerNorm(
                channels=channels
            ))

            self.norms_2.append(LayerNorm(
                channels=channels
            ))
...
class ResBlock1(nn.Module):
    def __init__(self,
                 *,
                 channels: int,
                 kernel_size: int = 3,
                 dilation: Union[int, List[int]] = (1, 3, 5)):
...
class ResBlock2(nn.Module):
    def __init__(self,
                 *,
                 channels: int,
                 kernel_size: int = 3,
                 dilation: Union[int, List[int]] = (1, 3)):
...
class ConvFlow(nn.Module):
    def __init__(self,
        ...
        self.proj = nn.Conv1d(
            ...
            out_channels=self.half_channels * (num_bins * 3 - 1),
            kernel_size=1
        )
